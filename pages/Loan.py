...
if st.button('Check my chances'):
    ...
    x = scaler.transform([[
                            number_of_people_who_will_provide_maintainance, 
                            map9_loan_history,
                            loan_amount_taken,
                            map1_guarantor_or_debtor,
                            years_of_employment,
                            number_of_loans_taken_from_current_bank,age,
                            map7_amount_in_current_account,
                            map8_amount_in_savings_account,
                            percent_income_paid_as_installment,
                            map10_other_loans_plans_taken,
                            map3_working_abroad,
                            time_duration_of_loan,
                            map4_Owned_property,
                            map6_type_of_job,
                            map2_type_of_housing,
                            map11_years_of_staying_in_current_residence
                        ]])

    #x = scaler.transform([[1,4,2671,1,2,1,50,2,2,4,2,1,36,0,2,0,4]])
    #print(x)
